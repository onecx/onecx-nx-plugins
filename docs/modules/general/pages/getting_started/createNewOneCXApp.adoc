...
The generator supports three flavors of projects angular with and without NgRx. It is recommended to use the NgRx flavor because it leads to better structured projects and currently the support in the generator is better for the NgRx flavor. If you plan to not use any onecx-services and build a standalone app with the components of OneCX, please use `+ngrx-standalone+`.
