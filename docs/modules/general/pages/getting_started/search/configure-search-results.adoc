...
Here you can create a mapping of your xref:getting_started/explanations.adoc#resource[`Resource`] to the row item used in the data table. This is also the place to add translation keys for columns with the type `TRANSLATION_KEY`.
