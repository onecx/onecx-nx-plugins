...
[NOTE]
====
The Request objects are referencing the xref:getting_started/explanations.adoc#resource[`Resource`], its properties are used by the form.
You can modify it, but check xref:getting_started/explanations.adoc#resource[`here`] for side effects.
...
Add new form fields similar to the generated example. Please, ensure that form control names match the xref:getting_started/explanations.adoc#resource[`Resource`] properties.
...
Add new form controls to the formGroup. Please, ensure that form control names match the properties of your xref:getting_started/explanations.adoc#resource[`Resource`].
