...
The blacklist file used for the blacklist scanning can be found in the users home directory. 
Now the required configuration files for the enabled validation checks are generated and the enabled checks are automatically performed before the changes can be committed.
