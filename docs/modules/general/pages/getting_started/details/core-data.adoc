...
For the details page, the generator also creates 2 actions for the header by default. Consider adding custom actions to available in the header. Please, reference the {page_header_url}[PageHeader docs] for more information on the `Action` usage.
