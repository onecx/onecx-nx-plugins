...
----
This is a marker used as a placeholder where extensions from newly generated components are inserted. Do not remove the marker from the code, as doing so will prevent the generated functions and tests from being added to the Search Page.
