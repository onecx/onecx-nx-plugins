...
.ACTION S2 in `+<resource>-search-header-section.component.tsx+`
[%collapsible]
====
[source, tsx]
----
    // ACTION S2: wire the breadcrumb home/items to your portal base route (the `href` MFE base) if needed
...
.ACTION S5 in `+<resource>-search.page.tsx+`
[%collapsible]
====
[source, tsx]
----
...
[#action-phase-3-2]
== ACTION S (Phase 3.2) - Results chart
...
.ACTION S (Phase 3.2) in `+<resource>-search.page.tsx+`
[%collapsible]
====
[source, tsx]
----
...
.ACTION S (Phase 3.3) in `+<resource>-search.page.tsx+`
[%collapsible]
====
[source, tsx]
----
