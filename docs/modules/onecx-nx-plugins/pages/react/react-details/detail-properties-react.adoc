...
----
  "BOOK_DETAILS": {
    ...
    "FORM": {
      ...
      // ACTION D3: Add additional form field translation keys here
    },
    "CANCEL": {
...
----
The `+// ACTION D3+` comment in the `FORM` section marks where to add a translation key for each additional form field. Replace the comment with your keys and adapt the default values to your application.
====
