...
Create a Search Component inside the *customer-management* feature module. Execute the following command with the *book-store* application as current working directory.

.Create a Search Component, without adapting names
[source,bash]
----
nx generate @onecx/nx-plugin:search customer-management
----

This command will generate a new search component *customer-management-search* within the specified feature module with the necessary structure and configurations.

.Excerpt of generated files and directories
image::generated_customer-management-search.png[width=250]