...
Using a Mock API provides a more realistic testing environment, as it simulates the actual API interactions that your app will have with a backend service.
There are different ways to prepare Mock APIs. Here we use {node_js_link}.
