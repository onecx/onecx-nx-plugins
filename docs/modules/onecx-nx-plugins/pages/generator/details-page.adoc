...
include::documentation:onecx-nx-plugins:partial$generator-check.adoc[]
...
include::documentation:onecx-nx-plugins:partial$generator-namespace-item.adoc[]
...
[start=1]
. xref:./details/core-data.adoc[Add core data to details page header]
. xref:./create-update/extend-form-fields.adoc[Extend form fields (for Edit Mode) ]
. xref:./details/commit-changes.adoc[Commit the changes]
