...
.Create a UI App named "help" (product) with NgRx support
[source,bash]
----
npx @onecx/create-workspace ngrx help
cd help
npm install
----
This command will generate a new workspace folder named "help" with the necessary structure and configurations for a OneCX UI App using NgRx. This can take a while, as the generator sets up a complete Angular application with all necessary dependencies and configurations.

.Excerpt of generated files and directories for the NgRx *help* UI App
image::generated_workspace_help.png[width=200]