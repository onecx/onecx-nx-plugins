...
[NOTE]
====
The Request objects are referencing the xref:generator/glossary.adoc#resource[`Resource`], its properties are used by the form.
You can modify it, but check xref:generator/glossary.adoc#resource[`here`] for side effects.
...
Add new form fields similar to the generated example. Please, ensure that form control names match the xref:generator/glossary.adoc#resource[`Resource`] properties.
...
Add new form controls to the formGroup. Please, ensure that form control names match the properties of your xref:generator/glossary.adoc#resource[`Resource`].
