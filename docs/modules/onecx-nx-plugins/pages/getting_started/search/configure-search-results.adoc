...
:data_table_column_properties_cookbook_url: xref:documentation:docs-guides-ui:angular/cookbook/components/interactive-data-view/data-table-column.adoc
:translation_cookbook_url: xref:documentation:docs-guides-ui:angular/cookbook/multi-language/multi-language.adoc
:api_scheme_url: xref:documentation:onecx-docs-dev:guides/api_guidelines.adoc
...
Here you can create a mapping of your xref:getting_started/glossary.adoc#resource[`Resource`] to the row item used in the data table. This is also the place to add translation keys for columns with the type `TRANSLATION_KEY`.
