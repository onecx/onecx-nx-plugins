...
You should have a xref:getting_started/glossary.adoc#feature[`+Search<Feature>Request+`]  defined in the OpenAPI specification.
By modifying the xref:getting_started/glossary.adoc#feature[`+Search<Feature>Request+`], you can add additional parameters to your search request.
...
The criteria you added in "Action S1" now have to be added to the xref:getting_started/glossary.adoc#feature[`+<feature>SearchCriteriasSchema+`].
