...
The easiest way to integrate the generated components into your application is to follow the OneCX Local Environment guidelines in {onecx_local_env_extend_ref}. This ensures that the components are correctly registered and accessible within the application.
